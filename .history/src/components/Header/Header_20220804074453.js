...
function Header() {
  ...
  return (
    <header className="flex relative items-center justify-center w-full h-[60px] md2:h-[80px] px-7 md2:px-[70px] bg-[#000000a2] backdrop-blur-md shadow-sm top-0 inset-x-0 z-30">
