          ...
          {[
            ...
            >
              ...
              <Image
                ...
                objectFit="cover"
              />
              <div className="flex items-center justify-center max-w-[540px] bg-[#0B0B0B] opacity-0 hover:opacity-100 w-full xs:h-[450px] overflow-hidden rounded-tl-3xl  absolute transition-all duration-500">
