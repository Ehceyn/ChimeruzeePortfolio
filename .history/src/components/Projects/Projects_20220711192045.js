...
function Projects() {
  return (
    <section className="px-[70px] mt-20">
      <div className=" w-full min-h-[80vh] h-[300px] bg-[#2020205b] rounded-3xl py-20">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-10 px-10">
          {[
            ...
            <div
              key={r.name}
              className="group max-w-lg bg-black w-[512px] overflow-hidden rounded-2xl border-[1px] border-gray-900 shadow-md object-cover mx-auto"
            >
              <a href="#">
                <Image
