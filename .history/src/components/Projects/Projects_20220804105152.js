              ...
              <div className="flex items-center justify-center max-w-[540px] bg-[#0B0B0B] opacity-100 hover:opacity-100 w-full xs:h-[450px] overflow-hidden rounded-2xl absolute transition-all duration-500">
                <div className="space-y-8 text-center">
                  ...
                  <a href="#" className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-x-5 gap-y-3 justify-center">
                      <a
                        href="#"
                        className="inline-flex items-center py-3 px-4 font-medium text-center text-white focus:ring-4 focus:outline-none bg-[#090909] rounded-md"
                      >
                        Visit site
                      </a>
                      <a
