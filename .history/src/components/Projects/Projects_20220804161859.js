      ...
      <div className=" w-full min-h-[80vh] bg-[#2020205b] md2:rounded-3xl py-20">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10 px-7 md:px-20">
          ...
          {[
            ...
            <div
              key={r.name}
              className="relative flex items-center justify-center max-w-[540px] bg-black w-full xs:h-[450px] overflow-hidden rounded-2xl border-[1px] border-gray-800 shadow-md shadow-[#030303] object-cover mx-auto"
            >
              {/* <a href="#"> */}
              <Image
                ...
                objectFit="cover"
              />
              <div className="hidden md:flex items-center justify-center max-w-[540px] background opacity-0 hover:opacity-100 w-full xs:h-[450px] overflow-hidden rounded-2xl absolute transition-all duration-500">
                  ...
                  <div className="space-y-8 text-center ">
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-x-5 gap-y-3">
                        <article className=" py-3 px-4 font-medium text-center text-white focus:ring-4 focus:outline-none bg-[#090909] rounded-md capitalize">
                          React
                        </article>
                        <article className=" py-3 px-4 font-medium text-center text-white focus:ring-4 focus:outline-none bg-[#090909] rounded-md capitalize">
                          nodeJS
