...
function Projects() {
  return (
    <section className="px-[70px]">
      <div className=" w-full min-h-[80vh] h-fit bg-[#2020205b] rounded-3xl py-20">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-10 px-10">
          {[
            { src: "/images/test1.png", name: "HTML" },
            { src: "/images/test2.png", name: "CSS" },
            { src: "/images/test1.png", name: "HTML" },
            { src: "/images/test2.png", name: "CSS" },
            { src: "/images/test1.png", name: "HTML" },
            { src: "/images/test2.png", name: "CSS" },
            ...
            <div
              key={r.name}
              className="group max-w-lg bg-black w-[512px] overflow-hidden rounded-2xl border-[2px] border-gray-900 shadow-md object-cover mx-auto"
            >
              <a href="#">
                <Image
