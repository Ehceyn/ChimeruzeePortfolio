      ...
      <div className=" w-full min-h-[80vh] bg-[#2020205b] md2:rounded-3xl py-20">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10 px-7 md:px-20">
          ...
          {[
            ...
            <div
              key={r.name}
              className="group flex items-center justify-center max-w-[540px] bg-black w-full xs:h-[450px] overflow-hidden rounded-2xl border-[1px] border-gray-800 shadow-lg shadow-[#181717ad] object-cover mx-auto"
            >
              {/* <a href="#"> */}
              <Image
