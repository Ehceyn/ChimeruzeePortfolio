    ...
    <section className="px-[70px]">
      <section className=" w-full min-h-[80vh] h-fit bg-[#00000086] rounded-3xl pt-10 pb-20">
        ...
        <article className="w-full flex justify-center mt-20">
          <button className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue">
            <p className="capitalize">View all projects</p>
          </button>
        </article>
      </section>
    </section>
