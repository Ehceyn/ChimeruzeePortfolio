  ...
  return (
    <section className="md2:px-[70px] mt-20">
      <div className=" w-full min-h-[80vh] bg-[#2020205b] md2:rounded-3xl py-20">
        ...
        {/* All project cards */}
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10 md:px-10">
          {[
            ...
            <div
              key={r.name}
              className="group bg-black w-full h-[400px]  overflow-hidden rounded-2xl border-[1px] border-gray-900 shadow-md object-cover mx-auto"
            >
              {/* <a href="#"> */}
              <Image
