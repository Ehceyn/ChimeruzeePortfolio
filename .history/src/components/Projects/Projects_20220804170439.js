      ...
      <div className=" w-full min-h-[80vh] bg-[#2020205b] md2:rounded-3xl py-20">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10 px-7 md:px-20">
          ...
          {[
            ...
            <div
              key={r.name}
              className="relative flex items-center justify-center md:max-w-[540px] bg-black w-full md:h-[450px] overflow-hidden rounded-2xl border-[1px] border-gray-800 shadow-md shadow-[#030303] object-cover mx-auto"
            >
              {/* <a href="#"> */}
              <Image
              ...
              {/* </a> */}
              <div className={`p-5 ${isMobile ? "block" : "hidden"} `}>
                <a href="#">
