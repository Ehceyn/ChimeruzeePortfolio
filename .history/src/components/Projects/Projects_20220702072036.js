    ...
    <section className="px-[70px]">
      <section className=" w-full min-h-[80vh] h-fit bg-[#00000086] rounded-3xl pt-10 pb-20">
        ...
        <article className="w-full flex justify-center mt-20">
          <button className="bg-transparent py-2 px-4 uppercase inline-flex items-center">
            View all projects
            <svg
              className="ml-2 -mr-1 w-7 h-7 group-hover:translate-x-1 transition-all duration-200 ease-in-out"
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
