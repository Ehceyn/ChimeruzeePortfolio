...
function Projects() {
  return (
    <section className="px-[70px]">
      <div className=" w-full min-h-[80vh] h-fit bg-[#00000086] rounded-3xl py-20">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-10 px-10">
          {[1, 2, 3, 4, 5, 6].map((r) => (
            <div
              key={r}
              className="group max-w-lg background2 w-[512px] rounded-lg border-[2px] border-gray-900 shadow-md object-cover  mx-auto"
            >
              <a href="#">
                <Image
