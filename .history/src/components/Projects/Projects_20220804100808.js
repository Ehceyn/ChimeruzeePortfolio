          ...
          {[
            ...
            >
              ...
              <Image
                ...
                objectFit="cover"
              />
              <div className=" max-w-[540px] bg-black opacity-0 hover:opacity-100 w-full xs:h-[450px] overflow-hidden rounded-2xl absolute transition-all duration-500 backdrop-blur-md">
                <a href="#">
