    ...
    <section className="md2:px-[70px] mt-20">
      <div className=" w-full min-h-[80vh] bg-[#2020205b] md2:rounded-3xl py-20">
          ...
          {[
            ...
            >
                ...
                <div className="space-y-8 text-center">
                  ...
                  <a href="#" className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-x-5 gap-y-3">
                      <a
                        href="#"
                        className="inline-flex py-3 px-4 font-medium text-center text-white focus:ring-4 focus:outline-none bg-[#090909] rounded-md capitalize"
                      >
                        React
                      </a>
                      <a
              ...
              {/* <div className="p-5">
                ...
                <a
                  href="#"
                  className="inline-flex py-2 px-3 text-sm font-medium text-center text-white focus:ring-4 focus:outline-none background rounded-md"
                >
                  Visit site
                  <svg
        ...
        <article className="w-full flex justify-center mt-20">
          <button className="group bg-transparent py-2 px-4 uppercase inline-flex">
            View all projects
            <svg
