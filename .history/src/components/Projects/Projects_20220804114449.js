          ...
          {[
            ...
            >
              ...
              <Image
                ...
                objectFit="cover"
              />
              <div className="flex items-center justify-center max-w-[540px] background opacity-0 hover:opacity-100 w-full xs:h-[450px] overflow-hidden rounded-2xl absolute transition-all duration-500">
                <div className="flex items-center justify-center max-w-[540px] rounded-tl-[100px] rounded-br-[100px] bg-[#0B0B0B]  w-full xs:h-[450px] overflow-hidden">
