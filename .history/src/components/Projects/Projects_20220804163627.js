      ...
      <div className=" w-full min-h-[80vh] bg-[#2020205b] md2:rounded-3xl py-20">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-10 px-7 md:px-20">
          ...
          {[
            ...
            <div
              key={r.name}
              className="relative md:flex items-center justify-center max-w-[540px] bg-black w-full h-52 md:h-[450px] overflow-hidden rounded-2xl border-[1px] border-gray-800 shadow-md shadow-[#030303] object-cover mx-auto"
            >
              {/* <a href="#"> */}
              <Image
                className="rounded-t-2xl md:rounded-2xl transition-all duration-200"
                src={r.src}
                alt=""
                width={600}
                height={1050}
                objectFit="cover"
              />
              <div className="hidden md:hidden items-center justify-center max-w-[540px] background opacity-0 hover:opacity-100 w-full xs:h-[450px] overflow-hidden rounded-2xl absolute transition-all duration-500">
