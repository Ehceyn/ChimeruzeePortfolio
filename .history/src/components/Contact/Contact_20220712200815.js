            ...
            <form className="">
              ...
              <div className="mb-6">
                ...
                <input
                  type="email"
                  id="email"
                  className="border grow focus:outline-none rounded-lg block w-full font-[Sintony-Regular] p-2.5 border-gray-600 bg-transparent placeholder-[#999] text-white focus:ring-[#0070fdff] focus:border-[#0070fdff]"
                  required
                />
              </div>
              <div className="mb-6">
