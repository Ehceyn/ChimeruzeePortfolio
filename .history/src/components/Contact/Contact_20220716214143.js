            ...
            <form className="flex md2:block flex-col items-center">
              <div className="mb-6 w-full">
                ...
                <input
                  type="text"
                  id="name"
                  className="border focus:outline-none rounded-lg block w-full font-[Sintony-Regular] p-2.5 border-gray-600 bg-transparent placeholder-[#999] text-white focus:ring-[#8a2387] focus:border-[#8a2387]"
                  required
                />
              </div>
