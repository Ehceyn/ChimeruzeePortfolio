      ...
      <div className="w-full  py-20 px-[70px] min-h-[80vh] bg-[#2020205b] h-fit">
        ...
        <div className="flex justify-center">
          ...
          <form className="">
            ...
            <button
              type="submit"
              className="text-white  focus:ring-4 focus:outline-none font-medium rounded-lg w-full sm:w-auto px-20 py-2.5 text-center background"
            >
              Send
            </button>
          </form>
          <article className="bg-red-500 flex w-full justify-self-end">
