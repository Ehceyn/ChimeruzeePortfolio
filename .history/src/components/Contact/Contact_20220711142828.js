            ...
            <form className="">
              <div className="mb-6">
                ...
                <input
                  type="email"
                  id="email"
                  className="border focus:outline-none rounded-lg block w-full p-2.5 border-gray-600 bg-transparent placeholder-gray-400 text-white focus:ring-gray-900 focus:border-gray-900"
                  required=""
                />
              </div>
              <div className="mb-6">
