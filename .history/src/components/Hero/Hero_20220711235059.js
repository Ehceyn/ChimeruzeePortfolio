...
function Hero() {
  ...
  return (
    <section className="flex flex-col-reverse md2:flex-row md2:justify-between justify-center items-center w-full min-h-[100vh]  pt-[80px] pb-20 px-5 md2:px-[40px] lg:px-[70px] ">
      {/* <video
        src="/video/vid.mp4"
      ...
      <div className="max-w-[250px] min-w-[250px] md2:max-w-[350px] md2:min-w-[350px] lg:max-w-[400px] lg:min-w-[400px] object-contain ">
        <motion.div
          ...
          className="border-[5px] md2:border-[10px] border-white rounded-full object-cover flex justify-center items-center p-[5px] md2:p-[10px] "
