...
function Hero() {
  return (
    <section className="flex justify-between items-center w-full h-[100vh] pt-[90px] px-[70px] ">
      <video
        src="/video/vid.mp4"
      ...
      <div className="w-fit leading-tight mr-[100px] ">
        ...
        <h3 className="flex items-center w-fit max-w-[800px] h-fit py-5 bg-black">
