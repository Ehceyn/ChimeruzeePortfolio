...
function Hero() {
  ...
  return (
    <section className="flex flex-col-reverse md2:flex-row md2:justify-between justify-center items-center w-full h-[100vh]  pt-[80px] pb-20 px-[40px] lg:px-[70px] ">
      {/* <video
        src="/video/vid.mp4"
        ...
        muted
      ></video> */}
      <div className="w-fit text-center md2:text-left leading-loose md2:mr-[100px] mt-[50px] md2:mt-0">
