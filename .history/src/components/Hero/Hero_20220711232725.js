...
function Hero() {
  ...
  return (
    <section className="flex flex-col-reverse md2:flex-row md2:justify-between justify-center items-center w-full h-[100vh]  pt-[80px] pb-20 px-[40px] lg:px-[70px] space-y-10 md2:space-y-0">
      {/* <video
        src="/video/vid.mp4"
