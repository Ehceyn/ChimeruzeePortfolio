...
function About() {
  return (
    <section className="">
      <div className=" w-full min-h-[80vh] h-fit relative bg-blue-400">
        <section className="absolute  py-20 h-fit w-full z-[1] ">
          <article className="w-full flex justify-center mb-10 md:mb-20">
            <h2 className="text-5xl md2:text-6xl lg:text-8xl">ABOUT ME</h2>
          </article>
          <div className="w-full flex flex-col items-center space-y-5 px-5 md2:px-0">
        ...
        <section className="absolute  py-20 h-fit w-full">
          <div className="flex justify-center relative min-h-[80vh]">
