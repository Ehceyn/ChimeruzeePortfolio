      ...
      <div className=" w-full min-h-[80vh] h-fit py-20">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-10 px-10">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((r) => (
            <div
              key={r}
              className="group w-fit bg-[#2020205b]  h-36 w-36  rounded-lg shadow-md object-cover  mx-auto"
            >
              <a
                href="#"
                className="flex justify-between items-centerrounded-lg shadow-md md:max-w-xl "
              >
                <Image
