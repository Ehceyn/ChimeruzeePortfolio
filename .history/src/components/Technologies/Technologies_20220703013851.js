      ...
      <div className=" w-full min-h-[80vh] h-fit py-20">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-10 px-10">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((r) => (
            <div
              key={r}
              className="group flex flex-col justify-center items-center bg-[#2020205b] py-10 px-14 rounded-lg shadow-md mx-auto"
            >
              <Image
                ...
                objectFit="contain"
              />
              <h4 className="mt-5  text-2xl font-bold tracking-tight">React</h4>
            </div>
          ))}
        </div>
      </div>
