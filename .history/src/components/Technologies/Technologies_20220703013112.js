      ...
      <div className=" w-full min-h-[80vh] h-fit py-20">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-10 px-10">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((r) => (
            <div
              key={r}
              className="group flex  justify-between items-center bg-[#2020205b] shadow-md h-36 w-36  rounded-lg shadow-md mx-auto"
            >
              <a href="#" className=" rounded-lg  ">
                ...
                <div className="flex items-center p-4 leading-normal">
                  <p className="mb-2 text-xl font-bold tracking-tight">React</p>
                </div>
              </a>
            </div>
          ))}
